...
class TimeSignalVisualizer(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("TimeFrequencyVisualizer - Sample Unbalance Condition - MOTOR DRIVER END , CHANNEL-1(Vertical)")
        
        # Default file paths
        self.default_time_signal_file = r"C:\Users\siris\Projects\Machine Fault Detection and Monitoring System\MFDMS\data\raw\MFFS UNBALANCE 1500 RPM\MOTOR DRIVEN END\TIME SIGNAL\CHANNEL 1\M-006.02  MOTOR DE_ 2 channel vib (11-12-2024 14_10_25) - Time Signal.txt"
        self.default_fft_file = r"C:\Users\siris\Projects\Machine Fault Detection and Monitoring System\MFDMS\data\raw\MFFS UNBALANCE 1500 RPM\MOTOR DRIVEN END\SPECTRUM\CHANNEL 1\M-006.02  MOTOR DE_ 2 channel vib (11-12-2024 14_10_25) - Spectrum.txt"
